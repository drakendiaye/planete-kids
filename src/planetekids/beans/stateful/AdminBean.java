...
public class AdminBean implements AdminRemote {
    ...
    public int createLabel(String name, String description_fr, String description_en, String site, String image_large, String image_medium,
            String image_small) throws Exception {
    ...
    public int createColor(String name_fr, String name_en, String description_fr, String description_en, String image_large,
            String image_medium, String image_small) throws Exception {
        ColorBean color = new ColorBean(new LocaleBean(name_fr, name_en), new LocaleBean(description_fr, description_en), image_large,
    ...
    public int createCategory(String name_fr, String name_en, String description_fr, String description_en, String image_large,
            String image_medium, String image_small) throws Exception {
        CategoryBean category = new CategoryBean(new LocaleBean(name_fr, name_en), new LocaleBean(description_fr, description_en),
    ...
    public List<ProductBean> getProductsByFilter(List<Integer> category_ids, List<Integer> color_ids, List<Integer> label_ids,
            List<Integer> age_ids, boolean and) throws Exception {
        ...
        if (!and) {
            ...
            while (iterator2.hasNext()) {
                ...
                if ((category_ids.size() == 0 || category_ids.contains(new Integer(product.getCategory().getId()))) && (color_ids.size() == 0 || color_ids.contains(new Integer(product.getColor().getId()))) && (age_ids.size() == 0 || age_ids.contains(new Integer(product.getAge().getId()))) && (label_ids.size() == 0 || label_ids.contains(new Integer(product.getLabel().getId())))) {
                    result.add(product);
                }
            }
        }
    ...
    public int createProduct(String name_fr, String name_en, String description_fr, String description_en, int category_id, int color_id,
            int label_id, int age_id, float price, int stock, String image_large, String image_medium, String image_small) throws Exception {
        ...
        AgeBean age = this.getAge(age_id);
        ProductBean product = new ProductBean(new LocaleBean(name_fr, name_en), new LocaleBean(description_fr, description_en), category,
                color, label, age, price, stock, image_large, image_medium, image_small);

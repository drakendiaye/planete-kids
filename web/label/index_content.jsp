        ...
        <div class="label">
            ...
            <div id="label_<s:property value="getId()" />_div">
                <div style="float:left;">
                    <img src="<s:property value="getImage_medium()" />" onmouseover="show('label_<s:property value="getId()" />_imgLarge')" onmouseout="hide('label_<s:property value="getId()" />_imgLarge')" width="50px" height="50px"/>
                    <img id="label_<s:property value="getId()" />_imgLarge" src="<s:property value="getImage_large()"/>" style="display:none; z-index:1; position:absolute; background-color:white; border-color:black; border-width:1px; border-style: solid;" width="100px" height="100px"/>
                </div>
                <div style="float:left;">

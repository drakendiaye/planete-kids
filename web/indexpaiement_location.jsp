...
<s:url id="url_content" namespace="/" action="paiement_content" includeParams="none"/>
<s:url id="url_location" namespace="/" action="paiement_location" includeParams="none"/>
<s:a onclick="navGo([new navRequest('content', '%{url_content}'),
     new navRequest('location', '%{url_location}')])">
    <s:text name="paiement"/>
</s:a>

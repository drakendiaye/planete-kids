...
public class ExternCustomer {
  ...
  try {
        ...
        try {
            ecomCustomerBean = (EcomCustomerRemote) initialContext
                    .lookup("ecom.beans.EcomCustomerBean" + "_"
                            + EcomCustomerRemote.class.getName() + "@Remote");
        } catch (NamingException e) {
	...
	private static void listProductStores(EcomCustomerRemote ecomCustomerBean) {
		try {
			// to be implemented
		} catch (Exception e) {
	 ...
	 */
	private static void listProducts(EcomCustomerRemote ecomCustomerBean, int productStoreId) {
		try {
			// to be implemented
		} catch (Exception e) {
	 ...
	 */
	private static void addProductToCart(EcomCustomerRemote ecomCustomerBean, int productId) {
		try {
			// to be implemented
		} catch (Exception e) {
	 ...
	 */
	private static void buyCart(EcomCustomerRemote ecomCustomerBean, int accountId) {
		try {
			// to be implemented
		} catch (Exception e) {
	 ...
	 *@param  accountId   Description of the Parameter
	 */
	private static void getAccountBalance(EcomCustomerRemote ecomCustomerBean, int accountId){
	// to be implemented
	}

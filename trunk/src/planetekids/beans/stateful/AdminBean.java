...
public class AdminBean implements AdminRemote {
	...
	public void createLabel(String name_fr, String name_en, String site, String image_large, String image_medium, String image_small)
			throws Exception {
	...
	public void createCategory(String name_fr, String name_en, String image_large, String image_medium, String image_small)
			throws Exception {
	...
	public List<ProductBean> getProductsByFilter(List<Integer> category_ids, List<Integer> color_ids, List<Integer> label_ids, boolean and)
			throws Exception {
	...
	public void createProduct(String name_fr, String name_en, String description_fr, String description_en, int category_id, int color_id,
			int label_id, float price, int stock, String image_large, String image_medium, String image_small) throws Exception {
		CategoryBean category = entityManager.find(CategoryBean.class, category_id);
		ColorBean color = entityManager.find(ColorBean.class, color_id);
		LabelBean label = entityManager.find(LabelBean.class, label_id);
		ProductBean product = new ProductBean(new LocaleBean(name_fr, name_en), new LocaleBean(description_fr, description_en), category,
				color, label, price, stock, image_large, image_medium, image_small);
